...
const { possibleWords } = require('./public_wotd/words')
const connectDB = require('./config/db')
const User = require('./models/User');
const ChristmasUser = require('./models/ChristmasUser');
...
//app.use("/secret-santa", express.static(path.join(__dirname, 'christmasCali')))
...
//Christmas Methods
// app.get('/secret-santa/users', async (req, res) => {
//     const users = await ChristmasUser.find()
//     res.json(users)
// })
